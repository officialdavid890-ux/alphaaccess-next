...
export default function Loans() {
  ...
  const offers = [
    { title: "Micro Loan", desc: "Quick access to ₦50,000 - ₦250,000 for immediate needs.", icon: <Wallet className="text-yellow-400" size={22} /> },
    { title: "Business Loan", desc: "Fund your next move with flexible repayment options.", icon: <TrendingUp className="text-yellow-400" size={22} /> },
    { title: "Credit Advance", desc: "Short-term credit solutions with low interest.", icon: <CreditCard className="text-yellow-400" size={22} /> },
  ];
      ...
      <div className="space-y-12 fade-in">
            ...
            {loans.map((loan, index) => (
              ...
              >
                ...
                <p className="text-sm text-gray-400">
                  Rate: <span className="text-yellow-300">{loan.rate}</span> | Term: <span className="text-yellow-300">{loan.term}</span>
                </p>
                <p
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {offers.map((offer, index) => (
              <motion.div
                ...
                className="p-6 border border-yellow-800/40 rounded-2xl bg-gradient-to-b from-black/70 to-yellow-950/10 shadow-[0_0_25px_rgba(234,179,8,0.1)] transition-all duration-300"
              >
                ...
                <motion.button
                  ...
                  className="w-full py-2 rounded-xl bg-gradient-to-r from-yellow-700 to-yellow-600 text-black font-semibold shadow-lg"
                  onClick={() => {
        ...
        <div>
          ...
          <motion.div
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            className="rounded-2xl p-6 border border-yellow-800/40 bg-gradient-to-b from-black/70 to-yellow-950/10 flex flex-col md:flex-row justify-between items-center text-yellow-200 shadow-[0_0_25px_rgba(234,179,8,0.1)]"
          >
            <div>
      ...
      <AnimatePresence>
        {showModal && (
          <>
            ...
            >
              <div className="bg-gradient-to-b from-black/90 to-yellow-950/10 border border-yellow-800/40 rounded-2xl p-8 w-full max-w-md shadow-[0_0_30px_rgba(234,179,8,0.15)] relative text-yellow-100">
                <button
                ...
                {processing ? (
                  <div className="flex flex-col items-center justify-center py-10 space-y-4">
                    ...
                    <p className="text-yellow-300 text-sm tracking-wider uppercase">
