    ...
    <Layout>
      ...
      >
        ...
        <div className="bg-slate border border-gold-800/40 rounded-2xl p-6 shadow-[0_0_20px_rgba(255,215,0,0.1)] space-y-6">
          ...
          <h2 className="text-xl font-semibold text-gold-400 border-b border-gold-900/50 pb-3">
          ...
          <div className="flex flex-col items-center space-y-2">
            ...
            <p className="text-gold-200 font-medium text-lg">
              <a
                href="mailto:info@alphaaccess.exchange"
                className="hover:text-gold-400 transition underline-offset-4"
              >
